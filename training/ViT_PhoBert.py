import json
from transformers import AutoTokenizer, ViTFeatureExtractor, DataCollatorWithPadding
from torch.utils.data import Dataset
from PIL import Image
import torch
from transformers import ViTModel, AutoModel, EarlyStoppingCallback, IntervalStrategy, AutoImageProcessor
...
# Create dataset
dataset = MultiModalDataset('vimmsd-train-increase-image-increase-text.json', tokenizer, feature_extractor)
...
# Save the model
torch.save(model.state_dict(), 'model-increase-image-increase-text.pth')