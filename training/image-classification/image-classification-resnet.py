...
# labels = [0 if entry['label'] == 'non-sarcasm' else 1 for entry in data.values()]
...
# # Create dataset
# dataset = MultiModalDataset(images, labels, tokenizer)
...
# # Save the model
# torch.save(model.state_dict(), 'training/image-classification/model-resnet50-add-multi-100-5.pth')
...
# Create datasets
train_dataset = MultiModalDataset(train_images, train_labels, tokenizer)
test_dataset = MultiModalDataset(test_images, test_labels, tokenizer)
